...
class Edit extends Component {
    ...
    handleEdit() {
        ...
        //@ потрібно алерт показувати, що все зберіглось добре, якщо виникла помилка, також це потрібно показати
    ...
    render() {
        return (
            <div>
                ...
                --> */}
                <form id="addUser" //незнаю достеменно чи ці поля обовязкові в даному випадку
                    ...
                    <label htmlFor="email">Email
                        <input type="email" id="email" defaultValue={this.props.emailUser}
                        />
                    </label>
                    <span></span>
                    <button
